...
//Code here
favoriteThings.food ='Chicken Nugggets'
favoriteThings.book = 'Happy Potter'
...
let gandalf = new Wizard('Gandalf', 70, 'Fireball')
gandalf.castSpell()
console.log (gandalf)
...
//Code Here
const newPhone1 = new Phone ('Apple', 'iPhone 13', 10, 'Black', 700)
const newPhone2 = new Phone ('Apple', 'iPhone 12', 20, 'White', 500)
const newPhone3 = new Phone ('Apple', 'iPhone 10', 15, 'Gray', 400)
...
//Code Here
const myFirstVehicle = new Vehicle (4, "Silver", 1000)
...
//Code Here 
const myFirstMotorcycle = new Motorcycle (1, 'Red', 3000, 'Kawasaki')
...
class Boat extends Vehicle {
  ...
  performMaintenance(){
    ...
    console.log(`Your ${this.type} is top notch!`)
  }
}
...
//Code Here
const myFirstBoat = new Boat (15, 'Magenta', 150, 'Mastercraft X26', 'yacht', true)
/*
